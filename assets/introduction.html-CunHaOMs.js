import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as n,b as t,e as o,d as i,o as s}from"./app-6YNAaEcB.js";const r={};function p(d,e){return s(),a("div",null,[n(" ## Introduction "),e[0]||(e[0]=t("h2",{id:"솔루션-소개",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#솔루션-소개"},[t("span",null,"솔루션 소개")])],-1)),n(` **CloudDesktop** is a system management software integrating local VHD offline startup, PXE network startup and management interfaces.

The software supports packaging operating systems into VHD files for local startup, and also supports PXE network startup. It provides both traditional interface and web management platform to realize centralized management of clients. `),e[1]||(e[1]=t("p",null,[t("strong",null,"Cloud-i"),o("는 로컬 VHD 오프라인 부팅, PXE 네트워크 부팅 및 관리 인터페이스를 통합한 시스템 통합 관리 소프트웨어입니다.")],-1)),e[2]||(e[2]=t("p",null,"이 소프트웨어는 로컬 부팅을 위해 운영체제를 VHD 파일로 패키징하는 것을 지원하고 PXE 네트워크 부팅도 지원합니다. 클라이언트의 중앙 집중식 관리를 실현하기 위해 전통적인 인터페이스와 웹 관리 플랫폼을 모두 제공합니다.",-1)),n(" ## Product Introduction "),e[3]||(e[3]=t("h2",{id:"핵심-기능",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#핵심-기능"},[t("span",null,"핵심 기능")])],-1)),n(` **CloudDesktop** implements the following core functions:
